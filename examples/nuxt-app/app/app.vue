      ...
      <div v-if="showSettings" class="settings-panel">
        ...
        <div class="setting-item">
          ...
          <input 
            ...
            @input="(e: any) => handleSettingsChange('work', e.target.value)"
            :disabled="isRunning"
          />
        </div>
        <div class="setting-item">
          ...
          <input 
            ...
            @input="(e: any) => handleSettingsChange('shortBreak', e.target.value)"
            :disabled="isRunning"
          />
        </div>
        <div class="setting-item">
          ...
          <input 
            ...
            @input="(e: any) => handleSettingsChange('longBreak', e.target.value)"
            :disabled="isRunning"
          />
        </div>
      </div>
...
<style scoped>
/* Reusing same styles as Vue app */
.pomodoro-container {
  max-width: 600px;
  margin: 0 auto;
  padding: 2rem;
