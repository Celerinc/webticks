<script lang="ts">
  ...
  function handleTimerComplete() {
    ...
    if (sessionType === 'work') {
      ...
      trackEvent('pomodoro_completed', {
        ...
        totalCompleted: completedPomodoros
      });

      if (completedPomodoros % 4 === 0) {
        trackEvent('session_milestone', {
          milestone: completedPomodoros,
          message: `Completed ${completedPomodoros} Pomodoros!`
        });
      }
  ...
  function handleSettingsChange(type: 'work' | 'shortBreak' | 'longBreak', value: string) {
    ...
    <div class="settings-panel">
      ...
      <div class="setting-item">
        ...
        <input 
          ...
          on:input={(e) => handleSettingsChange('work', e.currentTarget.value)}
          disabled={isRunning}
        />
      </div>
      <div class="setting-item">
        ...
        <input 
          ...
          on:input={(e) => handleSettingsChange('shortBreak', e.currentTarget.value)}
          disabled={isRunning}
        />
      </div>
      <div class="setting-item">
        ...
        <input 
          ...
          on:input={(e) => handleSettingsChange('longBreak', e.currentTarget.value)}
          disabled={isRunning}
        />
      </div>
    </div>
